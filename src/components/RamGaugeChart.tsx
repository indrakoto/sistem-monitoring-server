...
interface RamGaugeChartProps {
  usedGB: number
  totalGB: number
}

export default function RamGaugeChart({
  usedGB,
  totalGB
}: RamGaugeChartProps) {
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="grid grid-cols-2 gap-6 mt-6 w-full max-w-md">
          <div className="bg-gray-900 rounded-lg p-4">
            <div className="text-gray-400 text-sm mb-1">Used</div>
          ...
          <div className="bg-gray-900 rounded-lg p-4">
            ...
            <div className="text-gray-500 text-xs mt-1">
              {((totalGB - usedGB) / totalGB * 100).toFixed(1)}% free
            </div>
          </div>
        </div>
